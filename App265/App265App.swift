...
class AppDelegate: NSObject, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        Apphud.start(apiKey: "app_YAoEDZ8XqEVCB8GgdnchdaG4A2pT1y")
        
        OneSignal.initialize("d916f3a0-3531-4245-84c4-c69961c12aa9", withLaunchOptions: launchOptions)
        Amplitude.instance().initializeApiKey("93e78e38a61d9c7fd279e617ee6ddaf3")
